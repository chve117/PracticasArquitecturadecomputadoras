...
HD_PWD='C:/Users/Hassan/Desktop/Practicasarqui/Practica9/pilaHardware/pilaHardware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pilaHardware.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pilaHardware.tcl
