...
HD_PWD='C:/Users/Hassan/Desktop/Practicasarqui/practica6/ALU1bit/ALU1BIT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU4Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU4Bits.tcl
