...
HD_PWD='C:/Users/Hassan/Desktop/Practicasarqui/Practica8/memoriadatos/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoryData.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoryData.tcl
