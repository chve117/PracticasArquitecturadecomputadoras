...
HD_PWD='C:/Users/Hassan/Desktop/Practicasarqui/practica7/archivoRegistros/archivoRegistros.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log archivoRegistros.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source archivoRegistros.tcl
