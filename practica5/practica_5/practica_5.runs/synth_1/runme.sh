...
HD_PWD='C:/Users/Hassan/Desktop/Practicasarqui/practica5/practica_5/practica_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador8bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador8bits.tcl
